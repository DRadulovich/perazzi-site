...
### 1.2 V2-PGPT/V2_PreBuild-Docs/V2_Core-Brand-and-Strategy-Docs/...

- **File Path:** `V2-PGPT/V2_PreBuild-Docs/V2_Core-Brand-and-Strategy-Docs/V2_brand-bible.md`  
  **File Name:** `V2_brand-bible.md`  
  **What It Does:** Canonical brand pillars, values, and positioning. High-level summary of who Perazzi is and how it should be presented.

- **File Path:** `V2-PGPT/V2_PreBuild-Docs/V2_Core-Brand-and-Strategy-Docs/V2_brand-ethos.md`  
  **File Name:** `V2_brand-ethos.md`  
  **What It Does:** Describes the spirit of the brand (identity, mastery, legacy) and how to frame topics like price, lead times, and visibility as intentional strengths.

- **File Path:** `V2-PGPT/V2_PreBuild-Docs/V2_Core-Brand-and-Strategy-Docs/V2_audience-psychology-and-archetypes.md`  
  **File Name:** `V2_audience-psychology-and-archetypes.md`  
  **What It Does:** Defines motivational archetypes (Loyalist, Prestige, Analyst, Achiever, Legacy), how they tend to feel about Perazzi, and what kinds of messages and emphasis resonate with each.

- **File Path:** `V2-PGPT/V2_PreBuild-Docs/V2_Core-Brand-and-Strategy-Docs/V2_marketing-plan.md`  
  **File Name:** `V2_marketing-plan.md`  
  **What It Does:** Proposal-level marketing and campaign thinking. Used as design input for brand/spec work, but **not** ingested directly into the RAG corpus.
...
- **File Path:** `src/lib/perazzi-archetypes.ts`  
  **File Name:** `perazzi-archetypes.ts`  
  **What It Does:** Computes and smooths archetype vectors from user messages and context, applies simple heuristics and overrides, and returns a breakdown used to shape tone, bridge guidance, and meta responses (without changing facts or safety).

### 3.2 API Route

- **File Path:** `src/app/api/perazzi-assistant/route.ts`  
  **File Name:** `route.ts`  
  **What It Does:** API endpoint that runs retrieval, computes archetype profiling, assembles the GPT prompt, applies guardrails (including system/meta guardrails), handles fixed meta responses (origin, knowledge source), and returns the answer with citations, mode, and archetype breakdown.
