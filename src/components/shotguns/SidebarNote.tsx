...
export function SidebarNote({ title, html }: Readonly<SidebarNoteProps>) {
  return (
    <aside className="rounded-2xl border border-border/70 bg-card/60 p-4 type-body-sm text-ink shadow-soft backdrop-blur-sm sm:rounded-3xl sm:bg-card/80 sm:px-6 sm:py-6">
