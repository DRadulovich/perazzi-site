...
export function EngravingGradesCarousel({ grades, ui }: EngravingGradesCarouselProps) {
  ...
  return (
    <ExpandableSection
      key={carouselKey}
      sectionId="shotguns.engravingGradesCarousel"
  ...
  return (
    <>
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div
          data-es="scrim-top"
          className="absolute inset-0 overlay-gradient-canvas-80"
          aria-hidden
        />
      </div>

      <Container size="xl" className="relative z-10">
        <motion.div {...layoutProps} className={cn("relative", carouselMinHeight)}>
          <div
            data-es="glass"
            className={cn(
