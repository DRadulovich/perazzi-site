...
export function ConciergeHero({ hero }: ConciergeHeroProps) {
  ...
  return (
    <section
      ...
      className="relative isolate w-screen max-w-[100vw] overflow-hidden bg-perazzi-black text-white py-10 sm:py-16"
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-6 py-12 sm:px-10 lg:px-16 md:grid-cols-12 lg:gap-16">
        <div className="space-y-6 md:col-span-6 lg:col-span-7">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-full bg-brand px-4 py-2 text-[11px] sm:text-xs font-semibold uppercase tracking-[0.22em] text-white transition hover:bg-brand-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
            ...
            <Link
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-full border border-white/30 bg-white/10 px-4 py-2 text-[11px] sm:text-xs font-semibold uppercase tracking-[0.22em] text-white/90 transition hover:border-white hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
        ...
        <div className="space-y-4 rounded-2xl border border-white/20 bg-white/5 p-4 backdrop-blur-sm md:col-span-6 lg:col-span-5 sm:rounded-3xl sm:p-5">
          ...
          <div className="flex flex-wrap gap-2">
            {["Dealer brief ready", "Saved builds", "Desktop experience"].map((chip) => (
              <span
                key={chip}
                className="rounded-full border border-white/20 bg-white/10 px-3 py-1 text-[11px] sm:text-xs font-semibold uppercase tracking-[0.2em] text-white/80"
              >
                {chip}
              </span>
            ))}
