...
| V2-PGPT/V2_PreBuild-Docs/V2_Gun-Info-Docs/V2_RAG_corpus-base-models.md          | gun-info      | base-model-index    | active   | false             | full | Index/list doc; keep for metadata/lookup only to reduce retrieval noise. RESTRUCTURE NEEDED if you want narrative explanations. |
| V2-PGPT/V2_PreBuild-Docs/V2_Gun-Info-Docs/V2_RAG_corpus-disciplines.md          | gun-info      | discipline-index    | active   | false             |  full  | Index/list doc; keep for metadata/lookup only to reduce retrieval noise + oversized chunks. RESTRUCTURE NEEDED if you want narrative explanations. |
