...
| V2-PGPT/V2_PreBuild-Docs/V2_Gun-Info-Docs/V2_RAG_corpus-base-models.md          | gun-info      | base-model-index    | active   | false             | full        | Base-model headings with variant bullets (gauges, disciplines) for clustering. |
| V2-PGPT/V2_PreBuild-Docs/V2_Gun-Info-Docs/V2_RAG_corpus-disciplines.md          | gun-info      | discipline-index    | active   | false             | full        | Sections per discipline mix with model bullets; supports intent-based recall. |
